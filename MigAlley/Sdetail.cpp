...
#include "MISSSUB.H" //RERUN
#include "SAVEGAME.H" //RERUN
#include "COMMS.H" //RERUN
#include "WINMOVE.H" //RERUN
#include "SDETAIL.H"
//RERUN #include "rcombo.h"
#include "SAVEGAME.H"
#include "DISPLAY.H"
#include "OVERLAY.H"
#include "GAMESET.H"
...
//RERUN	: RowanDialog(CSDetail::IDD, pParent)
{
...
#include "SG2COMBO.H"
	...
	//the first entry must always be the 'Software MigDisplay Driver'
	pdd.LoadString(IDS_SOFTWAREDRIVER);
	combo->AddString(pdd);

	//the second entry must always be 'Primary MigDisplay Driver' if it is 3D capeable
