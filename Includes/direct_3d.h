...
enum {MAX_PALS=8}; //RERUN, decoupled from direct_3d
...
#else
	SDL_Surface* 	lpDD1TSurf;
	SDL_Surface* 	lpDD2TSurf;
#endif
	//SDL LPDIRECT3DTEXTURE   	lpD3DText;
	SDL_Texture* lpD3DText;
	//SDL D3DTEXTUREHANDLE		hTexture;
...
//
	...
	struct EDVidTex
	{
		...
		EDVidTex() {pdds=NULL;pdds2=NULL;pd3dt=NULL;d3dht=0;}
	};
...
//------------------------------------------------------------------------------
	...
	void TestHW3D(struct _DirectDraw*,MigWindow*);					//PD 23Sep97
	...
	void SetViewParams(ANGLES, MigWindow*,struct _DirectDraw*);
...
extern	void D3DErrorCodes(const char*,int,HRESULT);
#endif
